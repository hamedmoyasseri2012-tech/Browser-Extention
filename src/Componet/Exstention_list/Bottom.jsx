          ...
          <div className="flex flex-col  justify-center items-center gap-4 pl-4 pr-4 border bg-[#2f354b] rounded-xl w-100 h-55 ">
           ...
           items-center"
            >
              <button
                onClick={() => {}}
                className="border border-[#535969] text-xl font-medium text-[#aad1da] bg-[#535969] w-28.25 h-11.5 rounded-2xl hover:bg-[#2f354b] hover:border-3 hover:border-[#f35c55]"
              >
                Remove
              </button>
